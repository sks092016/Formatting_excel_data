...
# input file names
gps_shape_file = "References/Karanjiya/gps.shp"
segments_shape_file = "References/Karanjiya/OFC_NEW.shp"

version = f"{blockName}-1"

## The Start cordinate for main Rings is BHQ ##
BHQ_CORDINATE = '81.62631551 22.71147087'

rings = {
    'R1': BHQ_CORDINATE,
    'R2': BHQ_CORDINATE,
    'R3': BHQ_CORDINATE,
    'R1-C1':'81.43300010 22.73528609',
    'R1-C2':'81.49967190 22.71263870',
    'R2-C1':'81.51248220 22.57619240',
}
t_point_ring_spans = {
