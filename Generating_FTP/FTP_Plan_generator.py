...
label_in_attr = {
    "style":"edgeLabel;resizable=0;html=1;;align=right;verticalAlign=bottom;fontFamily=Georgia;fontStyle=1;fontColor=#0000CC;rotation=-90;fontSize=7;fillColor=none;",
    'height':30,
    'width':75,
}
label_out_attr = {
    "style":"edgeLabel;resizable=0;html=1;;align=right;verticalAlign=bottom;fontFamily=Georgia;fontStyle=1;fontColor=#4D9900;rotation=90;fontSize=7;fillColor=none;",
    'height':30,
    'width':75,
}
crmh_attr = {
    'style':"ellipse;whiteSpace=wrap;html=1;aspect=fixed;rounded=1;shadow=1;dashed=0;strokeColor=#6600CC;strokeWidth=2;align=center;verticalAlign=middle;spacingLeft=0;spacingTop=0;spacingBottom=80;fontFamily=Georgia;fontSize=8;fontColor=default;fontStyle=1;fillColor=default;",
    'height': 20,
    'width': 20,
}
...
def find_start_position(ring, ring_data, objects):
    if 'between' in ring['start']:
        ...
        end_node_position = objects[f"zmh_{node2}"].center_position
        ...
        if start_node_position[1] == end_node_position[1]:
            if start_node_position[0] < end_node_position[0]:
                ...
                crmh_start = (start_node_position[0] + x_off/2, start_node_position[1])
                print(crmh_start)
            else:
                x_off = start_node_position[0] - end_node_position[0]
                crmh_start = (end_node_position[0] + x_off/2, start_node_position[1])
                print(crmh_start)
        if start_node_position[0] == end_node_position[0]:
            y_off =  start_node_position[1] - abs(end_node_position[1])
            crmh_start = (end_node_position[0], end_node_position[1]+y_off/2)
            print(crmh_start)
        return crmh_start
